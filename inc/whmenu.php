...
li.item.has-sub-menu.open::after {
    transform: rotate(180deg);
}
li.item.has-sub-menu .hide-sub-menu{
	display:none !important;
}
li.item.has-sub-menu .show-sub-menu{
	display:block !important;
}
